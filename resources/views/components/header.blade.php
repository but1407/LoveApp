                ...
                <div class="col-sm-6">
                    <div class="social-icons pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li><a href="{{ getConfigValueFromSettingTable('youtube_link') }}"><i
                                        class="fa fa-youtube"></i></a></li>
                            <li><a href="{{ getConfigValueFromSettingTable('instagram_link') }}"><i
                                        class="fa fa-instagram"></i></a></li>
                            <li><a href="{{ getConfigValueFromSettingTable('github_link') }}"><i
                                        class="fa fa-github"></i></a></li>
                            <li><a href="{{ getConfigValueFromSettingTable('gmail_link') }}"><i
